...
\author{Simhadri Nayak \\normalsize CS22BTECH11049 \\ \large Playing songs from a playlist after shuffling}
...
\begin{document}
	...
	\newcommand{\mydet}[1]{\ensuremath{\begin{vmatrix}#1\end{vmatrix}}}
		...
		pygame module is used to load and play a random song from the list using mixer methods. 
		  ...
		  Then we can pause, play or forward to next song using keys p, r and n.
